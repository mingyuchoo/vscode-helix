...
export function right(document: vscode.TextDocument, position: vscode.Position, count = 1): vscode.Position {
...
export function rightNormal(document: vscode.TextDocument, position: vscode.Position, count = 1): vscode.Position {
  const lineLength = document.lineAt(position.line).text.length;
